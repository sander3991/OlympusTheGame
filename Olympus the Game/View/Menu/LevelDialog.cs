...
namespace Olympus_the_Game.View.Menu
{
    ...
    {
        private delegate void MapCallback(string mapName); //Callback voor dingen die buiten deze thread verzoeken tot het aanpassen van de buttons
        /// <summary>
        ...
        /// <param name="e"></param>
        void LevelDialog_MouseWheel(object sender, MouseEventArgs e)
        {
            if (e.Delta > 0)
                ScrollLoc--;
            else if (e.Delta < 0)
        ...
        /// <summary>
        /// We gebruiken deze method om ervoor te zorgen dat het toevoegen van deze buttons op onze thread gebeurd. En niet een WorkerThread
        /// </summary>
        ...
        /// <summary>
        /// We gebruiken deze method om ervoor te zorgen dat het verwijderen van deze buttons op onze thread gebeurd. En niet een WorkerThread
        /// </summary>
        /// <param name="mapName">De mapnaam van de toe te voegen level button</param>
        /// <param name="fileLocation">De file locatie van de toe te voegen button</param>
        ...
        /// <summary>
        /// Bij het klikken van een button wordt in de dictionary gekeken welke delegate er aangeroepen moet worden om een PlayField op te vragen
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
